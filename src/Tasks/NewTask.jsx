        ...
        <>
            <div className='bg-purple-500 flex-shrink-0  rounded-lg  h-full p-3 w-[370px] '>
                ...
                <div className='flex mt-3 gap-2 justify-between items-center'>
                    <button onClick={AcceptHandler} className="bg-green-700 cursor-pointer rounded-md p-3">Accept</button>

                    <button className="bg-red-700 rounded-md p-3" >Reject</button>
                </div>
            </div>
        </>
    )
